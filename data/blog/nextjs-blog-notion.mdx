...
![/static/images/nextjs-blog-notion.png](/static/images/nextjs-blog-notion.png)
...
![How content from data source is pulled and generated into websites like our blogs](/static/images/diagram.png)
...
![The database collection used to store all my blog posts](/static/images/database-collection-notion.png)
...
![Static site generation with external data (Next.js)](/static/images/nextjs-ssg-external-data.png)
