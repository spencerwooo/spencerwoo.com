...
![Banner](/static/images/wait-this-is-not-my-commit.png)
...
![一个目录，暂时不放具体仓库与地址](/static/images/200830_153718.png)
...
![/static/images/200830_154650.png](/static/images/200830_154650.png)

好奇心让我点开了同学发给我的链接，向下划到 Contributors，果然，我的头像就在那里。

![/static/images/200830_154938.png](/static/images/200830_154938.png)

淦，老子昨天才知道你这仓库的，宁真厉害

好嘛，除了我的头像，还有个我非常眼熟的头像 —— 下面这位老爷子：

![/static/images/200830_155124.png](/static/images/200830_155124.png)
...
![细节修改你个大头鬼啊，这里「我的」commit 周围都被篡改为我身边认识的大佬同学了](/static/images/200830_160029.png)
...
![Git 仓库的 commit 记录](/static/images/200830_163010.png)

Git 仓库的 commit 记录

我使用一个上周的 commit hash `df6eb5f`，我们可以用  `git cat-file -p df6eb5f`  来查看这一 commit 的具体信息：

![Commit hash 为 df6eb5f 的 commit 具体信息](/static/images/200830_163212.png)
...
![使用 GPG 签名的 commit 会在 GitHub 上显示 Verified 标志](/static/images/200830_165356.png)
...
![已经签名过的 commit 包含有我们使用的 PGP signature](/static/images/200830_172152.png)
